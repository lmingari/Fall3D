subroutine runend(message)
  ...
  !
  write(lulog,1) nwarn
1 format(/,2x,'Number of warnings    :',i2)
  do iwarn = 1,nwarn
     write(lulog,2) iwarn,TRIM(warning(iwarn))
  end do
2 format(3x,i2,' : ',a)
  !
...
10   format(2x,'Number of errors      : 1',2/, &
          2x,a)
     write(lulog,11)
11   format(2x,'PROGRAM SETSRC ends abnormally',/)
     close(lulog)
     ...
     !
     write(lulog,20)
20   format(2x,'Number of errors      : 0',2/, &
          2x,'PROGRAM SETSRC ends normally',/)
     close(lulog)
