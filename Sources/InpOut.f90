...
MODULE InpOut
  ...
  logical :: terrain_following = .true. ! output of 3D variables/cuts given terrain following(T) or a.s.l.(F)
  !
  !***  Postprocess counter
  !
  ...
  logical :: out_thick  = .false.
  logical :: out_concg  = .true.
  logical :: out_pm05g  = .false.
  logical :: out_pm10g  = .true.
  logical :: out_pm20g  = .false.
  logical :: out_cummc  = .true.
  logical :: out_pm05c  = .false.
  logical :: out_pm10c  = .false.
  logical :: out_pm20c  = .false.
  logical :: out_fl     = .false.
  logical :: out_aot05  = .false.
  !
